...
export const firebaseConfig = {
  apiKey: 'AIzaSyDKB2tmlvdIAvlGbwi39SQyijygNb9RwsA',
  authDomain: 'foodhub-admin-955a8.firebaseapp.com',
  projectId: 'foodhub-admin-955a8',
  storageBucket: 'foodhub-admin-955a8.firebasestorage.app',
  messagingSenderId: '673434242494',
  appId: '1:673434242494:web:61d132b0719efb9038bdef',
  // Optional: only used if you add Firebase Analytics later.
  measurementId: 'G-FPF8PQ2F08',
};
